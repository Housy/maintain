...
public class DormitoryController {
	...
	public Map<String, Object> getByPage(Dormitory query, PageInfo<Dormitory> pi){
		PageResult<Dormitory> pr = pi.toPageResult();
	 ...
	 */
	@RequestMapping("/add")
	public Result add(Dormitory obj){
		service.add(obj);
	...
	public Result update(Dormitory obj){
		service.update(obj);
		return Result.success();
	}
	...
	public Result update(Params p, Integer value){
		Dormitory old = service.findById(p.getId());
