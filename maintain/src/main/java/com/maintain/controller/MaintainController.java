...
public class MaintainController {
	...
	public Map<String, Object> getByPage(Maintain query, PageInfo<Maintain> pi){
		PageResult<Maintain> pr = pi.toPageResult();
	 ...
	 */
	@RequestMapping("/add")
	public Result add(Maintain obj){
		service.add(obj);
	...
	public Result update(Maintain obj){
		service.update(obj);
		return Result.success();
	}
	...
	public Result update(Params p, Integer value){
		Maintain old = service.findById(p.getId());
